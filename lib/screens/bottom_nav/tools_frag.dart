...
class ToolsFragment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const List<Tool> toolArray = [
      Tool(
          image: "assets/icons/ai_icon.jpg",
          title: "Garden AI",
      ...
      Tool(
          ...
          description:
              "Send us a request of a plant you want to see guides for!"),
      Tool(
              ...
              ToolCard(
                ...
                onClick: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (ctx) => const GardenAIScreen()));
                },
              ),
              ToolCard(
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (ctx) => const ScannerScreen(
                                scannerType: "Plant Identification")));
                  }),
              ToolCard(
              ...
              ToolCard(
                  ...
                  onClick: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (ctx) => const PlantRequestForm()));
                  }),
              ToolCard(
